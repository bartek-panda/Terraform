#wyjatkowo aws_default_subnet /vpc nie towrzy zasobow a pobiera dane z chmury podobnie jak data
...
# przypisujemy instancje EC2 do target grupy
resource "aws_lb_target_group_attachment" "tg_attach_frontend" {
